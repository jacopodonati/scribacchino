...
process_partials() {
    ...
    # Trova tutti i marcatori di parziali nel contenuto
    local partial_markers=($(echo "$content" | grep -o $'\xC2\xA0\xC2\xA0[^[:space:]]*\.html\xC2\xA0\xC2\xA0'))
